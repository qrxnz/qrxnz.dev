...
tags: [posts, vulnlab, ctf, misconfigurations, rsync, php, sqlite, ftp, ssh]
summary: "Pivoting from an exposed rsync backup through a cracked PHP/SQLite hash, an FTP-writable home dir and a root-owned backup script."
permalink: /blog/sync-vl/
---

![pwned-sync](/img/blog/sync-vl/image-17.png)
...
![rsync](/img/blog/sync-vl/image.png)
...
![backups](/img/blog/sync-vl/image-11.png)
...
![linpeas](/img/blog/sync-vl/image-14.png)
